...
<div class="contenedor">
    ...
    <details class="panel-formulario" ${registroEditar != null ? 'open' : ''}>
        <summary class="boton-desplegar">
            ${registroEditar != null ? 'Editar usuario' : 'Crear nuevo usuario'}
        </summary>
        ...
        <form action="${pageContext.request.contextPath}/Tabla_Usuarios" method="post" class="formulario">
            ...
            <input type="number" name="roles_idRoles" placeholder="Rol" value="${registroEditar.roles_idRoles}" required>
            ...
            <c:forEach var="u" items="${listaUsuarios}">
                <tr>
                    ...
                    <td class="acciones-tabla">
                        <form action="${pageContext.request.contextPath}/Tabla_Usuarios" method="post">
                            <input type="hidden" name="accion" value="editar">
                            <input type="hidden" name="id" value="${u.id_Usuarios}">
                            <button class="editar" type="submit">Editar</button>
                        </form>
                        <form action="${pageContext.request.contextPath}/Tabla_Usuarios" method="post">
                            <input type="hidden" name="accion" value="eliminar">
                            <input type="hidden" name="id" value="${u.id_Usuarios}">
                            <button class="eliminar" type="submit" onclick="return confirm('Desea eliminar este usuario?')">Eliminar</button>
                        </form>
                    </td>
                </tr>
            </c:forEach>
